<?php
// Simple Car Rental ERP System - Complete Version with Edit Functionality for ALL Pages
...
<body>
    ...
    window.onclick = function(event) {
        const modals = ['editVehicleModal', 'editCustomerModal', 'editReservationModal'];
